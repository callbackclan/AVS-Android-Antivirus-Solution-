...
jclass jniFindClass(JNIEnv *env, const char *name) {
    ...
    if (cls == NULL)
        log_android(ANDROID_LOG_ERROR, "hello its' me , Class %s not found", name);
    else
...
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    //const char *signature = "(com/example/customguard/Packet;)V";
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(com/avsolution/nativeFiles/ResourceRecord;)V";
    if (midDnsResolved == NULL)
        midDnsResolved = jniGetMethodID(args->env, clsService, "dnsResolved", signature);

    const char *rr = "com/avsolution/nativeFiles/ResourceRecord";
    if (midInitRR == NULL)
...
//    const char *signature = "(com/avsolution/nativeFiles/Packet;)com/avsolution/nativeFiles/Allowed;";
...
jobject create_packet(const struct arguments *args,
    ...
    const char *packet = "com/avsolution/nativeFiles/Packet";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    const char *signature = "(com/avsolution/nativeFiles/Usage;)V";
    if (midAccountUsage == NULL)
        midAccountUsage = jniGetMethodID(args->env, clsService, "accountUsage", signature);

    const char *usage = "com/avsolution/nativeFiles/Usage";
...
Java_com_avsolution_nativeFiles_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
...
Java_com_avsolution_nativeFiles_Util_is_1numeric_1address(JNIEnv *env, jclass type, jstring ip_) {
    jboolean numeric = 0;
...
Java_com_example_customguard_Util_dump_1memory_1profile(JNIEnv *env, jclass type) {
#ifdef PROFILE_MEMORY
...
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1init(
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1start(
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1run(
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1stop(
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1clear(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
    clear(ctx);
}
...
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1get_1stats(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_com_avsolution_nativeFiles_ServiceSinkhole_jni_1done(
        JNIEnv *env, jobject instance, jlong context) {
    struct context *ctx = (struct context *) context;
