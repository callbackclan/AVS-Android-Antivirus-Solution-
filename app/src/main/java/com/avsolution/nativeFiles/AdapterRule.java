...
public class AdapterRule extends RecyclerView.Adapter<AdapterRule.ViewHolder> implements Filterable {
    private static final String TAG = "Customguard.Adapter";
...
//            });
    ...
    public AdapterRule(Context context, View anchor) {
        ...
        colorGrayed = ContextCompat.getColor(context, R.color.pink);
...
//        }
        ...
        // Wi-Fi settings
//        holder.cbWifi.setVisibility(View.INVISIBLE);
...
//        }
        ...
        holder.cbOther.setAlpha(otherActive ? 1 : 1);
...
//                main.putExtra(MainActivity.EXTRA_SEARCH, Integer.toString(rule.uid));
//                main.putExtra(MainActivity.EXTRA_RELATED, true);
...
////                                    ClipData clip = ClipData.newPlainText("customguard", daddr);
